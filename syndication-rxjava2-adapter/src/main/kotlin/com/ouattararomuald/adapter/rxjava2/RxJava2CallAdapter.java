...
final class RxJava2CallAdapter<SyndicationType> extends CallAdapter<SyndicationType, Object> {
  ...
  RxJava2CallAdapter(@Nullable Scheduler scheduler, boolean isAsync, boolean isFlowable,
